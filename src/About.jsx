...
<div class="card">
  <div class="content">
    <img id="dd" src="./public/SAIPHOTONPTEL.JPG" alt="project1" width={'150px'}/>
    <p class="para">
  ...
  <div style={{display:"flex",justifyContent:"space-evenly",width:"100%",gap:"10px"}}>
  <button onClick={openre}>Resume</button>
  <button onClick={opencon}>Contact me</button>
  </div>
  </div>
</div>
</div>
